    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            if len(face_rects) > 0:
                ...
                print(f'pitch:{har}, yaw:{yaw}, roll:{roll}')
                ...
                for (start, end) in line_pairs:
                    # print(start, end)
                    cv2.line(img=frame, pt1=(int(reprojectdst[start][0]), int(reprojectdst[start][1])),
                ...
                cv2.putText(frame, "Z: " + "{:7.2f}".format(euler_angle[2, 0]), (20, 80), cv2.FONT_HERSHEY_SIMPLEX,
                            0.75, (0, 0, 255), thickness=2)
                cv2.putText(frame, "Nod: {}".format(hTOTAL), (450, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                            (255, 255, 0), 2)
            if hTOTAL >= 30:
