...
# 处理存放所有人脸特征的 csv
path_features_known_csv = "./persons/feature/Gean_feature/Gean_feature_all.csv"
                ...
                if min(e_distance_list) < 0.4:
                    ...
                    for name in file_names:
                        ...
                        if sum == key_id:
                            ...
                            name_namelist[k] = name.split('_')[0]   # 人名删去第一个数字（用于视频输出标识）
                        key_id += 1
                    # 播放欢迎光临音效
                    playsound('../mp3/3.mp3')
                    ...
                    for i, d in enumerate(faces):
                        ...
                        # 要存储visitor人脸图像文件的路径
                        path_visitors_save_dir = "./persons/visitor/known"
                    ...
                    for i, d in enumerate(faces):
                        ...
                        path_visitors_save_dir = "./persons/visitor/unknown"
